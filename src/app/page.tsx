...
import { Calendar, Clock, Settings, Plus, LogOut, Search, Users, User, ChevronDown, Loader2 } from 'lucide-react'
                        ...
                        >
                          <div>
                            <div className="font-medium text-sm">
                              {slot.description || (isCyclic ? 'Каждую неделю' : 'Разово')}
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <div className="font-medium">Только этот день</div>
                            <div className="text-xs text-gray-500">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <div className="font-medium text-red-700">Все дни этой записи</div>
