...
> **Коммит:** Обновление timezone handling
...
- Обновлён TimeFinderService для конвертации времени
- Добавлена библиотека date-fns-tz

### 3. Vercel не деплоит после git push
**Статус:** ИЗВЕСТНО
**Причина:** Vercel подключен к ветке `master`, а не `main`
**Решение:** Force push в обе ветки или ручной trigger deployment
